...
export default class extends Component {
   ...
   */
  connect ({ roomName, accessToken, enableVideo = true, enableAudio = true, encodingParameters }) {
    TWVideoModule.connect(accessToken, roomName, enableVideo, enableAudio, encodingParameters)
  }
